...
public class CrossbodyBag extends Bag{
     ...
     * as well as given number of straps.
     *
     * @param color Color of CrossbodyBag
     * @param capacity Maximum items in CrossbodyBag
     * @param numberOfStraps Number of Straps in the CrossbodyBag.
     */
